...
$(document).ready(function() {
    $("header").load("/coldigo-eclipse/pages/site/general/cabecalho.html");
    $("nav").load("/coldigo-eclipse/pages/site/general/menu.html");
    $("footer").load("/coldigo-eclipse/pages/site/general/rodape.html");
});